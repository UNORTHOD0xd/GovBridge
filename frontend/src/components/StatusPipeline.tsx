        ...
        return (
          <div key={step} className="flex items-center flex-1">
            <div className="flex flex-col items-center flex-1">
              ...
              <div
                className={`
                  w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 rounded-full flex items-center justify-center text-[10px] sm:text-xs font-bold
                  transition-all duration-500 ease-out
                  ${isComplete
                    ? isCurrent
                      ? "bg-green-500 text-white ring-2 sm:ring-4 ring-green-200 scale-110"
              ...
              <span
                className={`
                  text-[8px] sm:text-[10px] mt-0.5 sm:mt-1 font-medium transition-colors duration-300
            ...
            {/* Connector line */}
            {!isLast && (
              <div className="flex-1 h-0.5 mx-0.5 sm:mx-1 -mt-3 sm:-mt-4 relative overflow-hidden rounded-full bg-gray-200">
                <div
