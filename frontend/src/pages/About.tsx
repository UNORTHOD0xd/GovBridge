  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-yellow-900">
      ...
      <header className="border-b border-white/10">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/login" className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl">GovBridge</span>
          </Link>
          <Link
            to="/login"
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <h2 className="text-2xl font-bold text-white mb-2">The Problem Today</h2>
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-green-200/80 text-sm mt-1">{item.pain}</p>
                </div>
                <div className="text-right shrink-0">
                  <p className="text-yellow-400 font-semibold text-sm">{item.time}</p>
        ...
        <p className="mt-4 text-green-300/60 text-sm text-center">
      ...
      {/* The Solution */}
      <section className="max-w-5xl mx-auto px-6 py-12">
        <h2 className="text-2xl font-bold text-white mb-2">How GovBridge Fixes This</h2>
        <p className="text-green-200 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {PILLARS.map((pillar) => (
            ...
            >
              <div className="text-green-400 mb-4">{pillar.icon}</div>
              ...
              <p className="text-green-200/80 text-sm leading-relaxed">{pillar.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-red-500/10 border border-red-400/20 rounded-xl p-6">
            <h3 className="text-red-300 font-bold text-lg mb-4">Without GovBridge</h3>
            <ol className="space-y-3 text-sm text-red-200/80">
          ...
          <div className="bg-green-500/10 border border-green-400/20 rounded-xl p-6">
            <h3 className="text-green-300 font-bold text-lg mb-4">With GovBridge</h3>
            <ol className="space-y-3 text-sm text-green-200/80">
              <li className="flex gap-3">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm">
          <h3 className="text-white font-bold text-lg mb-2">Why On-Chain Verification?</h3>
